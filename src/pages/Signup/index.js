...
const  football = () => (
	...
	alert("You are signing up as a passenger!")
);

const  driver = () => (
	  
	alert("You are signing up as a driver!")
);
const  business = () => (
	  
	alert("You are signing up as a business!")
);
						...
						className="h-24 border-2 border-black bg-white flex flex-col justify-center ">
							<div className="mx-2 my-2 pt-2 flex flex-col items-center">
								...
								<a
									...
									data-aos-duration="1000"
								className="font-sans font-semibold text-center" href="#" onClick={football}>
						...
						className="h-24 ml-5 border-2 border-black bg-white flex flex-col justify-center">
							...
							className="mx-2 my-2 pt-2 flex flex-col items-center">
								...
								<a
									...
									data-aos-duration="1000"
								className="font-sans font-semibold text-center" href="#" onClick={driver}>
						...
						className="h-24 ml-5 border-2 border-black bg-white flex flex-col justify-center">
							...
							className="mx-2 my-2 pt-2 flex flex-col items-center">
								...
								<a
									...
									data-aos-duration="1000"
								className="font-sans font-semibold text-center" href="#" onClick={business}>
